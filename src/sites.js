const resources = [
  ...
  },
  {
    ...
    description: "A simple cart made with ReeactJS using context API",
  ...
  },
  {
    ...
    description:
      "Directory membership for promotional merchandise supplier. The site provide a simple way to source promotional items in UK.",
  ...
  {
    title: "Managed",
    description: "A template made with Tailwind CSS",
